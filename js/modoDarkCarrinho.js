...
darkMode.addEventListener('click', () => {
    ...
    const caixa_carrinho = document.querySelector('.caixa-carrinho');
    const tituloProdutoCarrinho = document.querySelectorAll('.tituloProdutoCarrinho');
    const precoProdutoCarrinho = document.querySelectorAll('.precoProdutoCarrinho');
    const quantidadeCarrinho = document.querySelectorAll('.quantidadeCarrinho');
    const botaoMaisCarrinho = document.querySelectorAll('.botaoMaisCarrinho');
    const botaoMenosCarrinho = document.querySelectorAll('.botaoMenosCarrinho');
    const inputNumberCarrinho = document.querySelectorAll('.inputNumberCarrinho');
    const botaoFinalizarCompra = document.querySelector('.botaoFinalizarCompra');
    ...
    caixa_carrinho.classList.toggle('dark')
    tituloProdutoCarrinho.forEach(e=> {
        e.classList.toggle('dark')

    })
    precoProdutoCarrinho.forEach(e=> {
        e.classList.toggle('dark')

    })
    quantidadeCarrinho.forEach(e=> {
        e.classList.toggle('dark')

    })
    botaoMaisCarrinho.forEach(e=> {
        e.classList.toggle('dark')

    })
    botaoMenosCarrinho.forEach(e=> {
        e.classList.toggle('dark')
    ...
    inputNumberCarrinho.forEach(e=> {
        e.classList.toggle('dark')

    })
    botaoFinalizarCompra.classList.toggle('dark')
